...
spec :: Spec
spec = do
  describe "String" $ tests $ ryu @ScientificNotation @Double @String
  describe "ByteString" $ tests $ ryu @ScientificNotation @Double @B.ByteString
  describe "Lazy ByteString" $ tests $ ryu @ScientificNotation @Double @BL.ByteString
  describe "Text" $ tests $ ryu @ScientificNotation @Double @T.Text
  describe "Lazy Text" $ tests $ ryu @ScientificNotation @Double @TL.Text

tests :: (IsString text, Show text, Eq text) => (Double -> text) -> Spec
tests ryu' = do
      describe "Basic" do
